...
export const SCHEMAS: Record<string, Schema> = {
  ...
  "pages/tankless-rebates": {
    key: "pages/tankless-rebates",
    title: "Tankless Rebates Page",
    fields: [
      { name: "hero", label: "Hero", type: "group", of: [
        { name: "badge", label: "Badge", type: "text" },
        { name: "headline", label: "Headline", type: "text" },
      ...
      { name: "rebatesSection", label: "Rebates Section", type: "group", of: [
        { name: "label", label: "Section label", type: "text" },
        { name: "heading", label: "Heading", type: "text" },
        { name: "paragraph", label: "Paragraph", type: "textarea" },
        { name: "rebates", label: "Rebate cards", type: "repeatable", of: [
          { name: "label", label: "Label", type: "text" },
          { name: "amount", label: "Amount", type: "text" },
          { name: "desc", label: "Description", type: "textarea" },
          { name: "icon", label: "Icon name", type: "text" },
        ]},
        { name: "totalLabel", label: "Total label", type: "text" },
        { name: "totalAmount", label: "Total amount", type: "text" },
        { name: "totalParagraph", label: "Total paragraph", type: "textarea" },
        { name: "ctaGetQuoteText", label: "Get quote CTA text", type: "text" },
      ]},
      { name: "howWeHandleItSection", label: "How We Handle It Section", type: "group", of: [
        { name: "label", label: "Section label", type: "text" },
        { name: "heading", label: "Heading", type: "text" },
        { name: "steps", label: "Steps", type: "repeatable", of: [
          { name: "step", label: "Step number", type: "text" },
      ...
      { name: "whyTanklessSection", label: "Why Tankless Section", type: "group", of: [
        { name: "label", label: "Section label", type: "text" },
        { name: "heading", label: "Heading", type: "text" },
        { name: "paragraph", label: "Paragraph", type: "textarea" },
        { name: "bullets", label: "Bullet points", type: "list" },
        { name: "savingsCardLabel", label: "Savings card label", type: "text" },
        { name: "savingsRebatesLabel", label: "Rebates label", type: "text" },
        { name: "savingsRebatesAmount", label: "Rebates amount", type: "text" },
        { name: "savingsBillsLabel", label: "Bills label", type: "text" },
        { name: "savingsBillsAmount", label: "Bills amount", type: "text" },
        { name: "savingsTotalLabel", label: "Total savings label", type: "text" },
        { name: "savingsTotalAmount", label: "Total savings amount", type: "text" },
        { name: "savingsDisclaimer", label: "Savings disclaimer", type: "textarea" },
      ]},
      { name: "faqsSection", label: "FAQs Section", type: "group", of: [
        { name: "title", label: "Section title", type: "text" },
        { name: "faqs", label: "FAQs", type: "repeatable", of: [
  ...
  "pages/tankless-services": {
    key: "pages/tankless-services",
    title: "Tankless Services Page",
    fields: [
      { name: "meta", label: "SEO / Meta", type: "group", of: [
        { name: "title", label: "Page title", type: "text" },
        { name: "description", label: "Meta description", type: "textarea" },
